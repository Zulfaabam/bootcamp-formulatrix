...
namespace SyntaxDemo
{
    ...
    public class Program
    {
        ...
        public static void Main(string[] args)
        {
            ...
            // Abam's
            Logger logger = new Logger("Abam's Logger - Trying Jetbrains Rider IDE");
            logger.Out();
    ...
    // This is Abam trying the Jetbrains Rider IDE
    public class Logger
    {
        private string _sentences;

        public Logger(string sentences)
        {
